...
/**
 * Crea una interfaz llamada Figura que contenga los siguientes métodos:
 ...
 * Finalmente, crea una clase de prueba (Main) donde instancies un círculo
 * y un rectángulo, y muestres por consola su área y perímetro.
 */
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("El área de este rectángulo es: "
        + rectangulo1.calcularArea() + "cm2");
    System.out.println("El perímetro de este rectángulo es: "
        + rectangulo1.calcularPerimetro() + "cm");
  }
}